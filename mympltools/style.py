...
import sys
from typing import Any, ChainMap, Dict, Optional, Sequence, Union
...
Style = Union[str, Dict[str, Any], ChainMap[str, Any]]
...
# style used in a presentation in October 2021
mystyle_21_10 = ChainMap(
    seaborn_colorblind_10,
    {
        "axes.linewidth": 1.2,
        "font.size": 16,
