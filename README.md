...
```bash
pip install git+https://github.com/tueda/mympltools.git@22.5.1
```

[Poetry](https://python-poetry.org/):
```bash
poetry add git+https://github.com/tueda/mympltools.git@22.5.1
```

[PDM](https://pdm.fming.dev/):
```bash
pdm add git+https://github.com/tueda/mympltools.git@22.5.1
```
